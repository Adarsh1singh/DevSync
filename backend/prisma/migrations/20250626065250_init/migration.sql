...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_UPDATED', 'COMMENT_ADDED', 'PROJECT_ASSIGNED', 'TEAM_INVITE');
...
-- CreateIndex
CREATE UNIQUE INDEX "task_labels_name_projectId_key" ON "task_labels"("name", "projectId");
